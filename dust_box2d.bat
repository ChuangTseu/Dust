...
cmake .. -G"MinGW Makefiles" %DUST_CMAKE_COMPILER_HINT% -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX="%DEDICATED_PREFIX%" -DBOX2D_INSTALL=ON -DBOX2D_BUILD_EXAMPLES=OFF -DBOX2D_BUILD_SHARED=ON -DBOX2D_INSTALL_DOC=OFF
