...
SET DEDICATED_PREFIX=%DUST_CURRENT_LIBRARY_DEDICATED_USR%/freeglut-3.0.0-rc1
...
cmake .. -G"MinGW Makefiles" %DUST_CMAKE_COMPILER_HINT% -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX="%DEDICATED_PREFIX%" -DFREEGLUT_BUILD_DEMOS=OFF
